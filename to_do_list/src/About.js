...
function About() {
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-900 to-purple-900 p-3 text-white">
            ...
            >
                <div className="bg-gradient-to-br from-purple-900/80 to-pink-900/50 rounded-2xl p-8 md:p-12 border border-purple-700/30 shadow-2xl">
                    <div className="flex flex-col md:flex-row gap-8 items-center">
                        <div className="md:w-1/2">
                            <h2 className="text-3xl font-bold mb-6">XP & Reward System</h2>
                        ...
                        <div className="md:w-1/2">
                            <div className="bg-gray-800/50 p-6 rounded-xl border border-purple-700/50">
                                <div className="flex justify-between mb-2">
                                    <span className="text-sm">Level 5 Hero</span>
                                    <span className="text-sm">600/1000 XP</span>
                                </div>
                                ...
                                <div className="mt-8 grid grid-cols-3 gap-4">
                                    {[1, 2, 3].map((badge) => (
                                        <div key={badge} className="text-center">
                                            <div className="bg-purple-900/50 rounded-full p-3 mx-auto w-16 h-16 flex items-center justify-center mb-2">
            ...
            >
                <div className="text-center mb-16">
                    <h2 className="text-3xl font-bold mb-4">Why Join The Adventure?</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="bg-gradient-to-br from-gray-800/50 to-purple-900/30 p-8 rounded-2xl border border-purple-800/50">
                    ...
                    <div className="bg-gradient-to-br from-gray-800/50 to-pink-900/30 p-8 rounded-2xl border border-pink-800/50">
                        <h3 className="text-2xl font-semibold mb-4 flex items-center gap-3">
            ...
            >
                <div className="bg-gradient-to-br from-purple-900/50 to-pink-900/50 rounded-2xl p-12 border border-purple-700/30">
                    <h2 className="text-3xl md:text-4xl font-bold mb-6">Ready to Begin Your Quest?</h2>
                    <p className="text-xl text-purple-200 mb-8 max-w-2xl mx-auto">
                        Join thousands of heroes who are turning their daily tasks into epic adventures.
                    </p>
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <button className="px-8 py-3 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full font-medium hover:scale-105 transition-transform shadow-lg hover:shadow-purple-500/30">
                            Get Started Now
                        </button>
                        <button className="px-8 py-3 bg-transparent border border-purple-400 rounded-full font-medium hover:bg-purple-900/30 transition-colors">
                            Learn More
                        </button>
                    </div>
                </div>
